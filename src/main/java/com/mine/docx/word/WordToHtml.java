...
/**
 * @Description: Word文档模型化解析(只支持.doc)
...
public class WordToHtml {
    ...
    public static final String inputFile = "F:\\feifei.liu\\试卷导入模板.doc";
    public static final String htmlFile = "F:\\feifei.liu\\试卷导入模板.html";
...
//        return FileUploadPathConfig.FILE_UPLOAD_BASE + "upload/wordImage/" + DateFormatUtil.formatDate(new Date());
        return "F:\\feifei.liu/var/e_learning/upload/wordImage/" + DateFormatUtils.format(new Date(), "yyyyMMdd");
    }
...
//        return "F:\\feifei.liu/var/e_learning/upload/wordImage/" + DateFormatUtil.formatDate(new Date()) + "/";
        return "F:\\feifei.liu/var/e_learning/upload/wordImage/" + DateFormatUtils.format(new Date(), "yyyyMMdd") + "/";
    }
